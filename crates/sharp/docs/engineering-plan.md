...
Concrete plan for implementing Sharp v1. Pairs with the protocol specification in [`whitepaper.md`](./whitepaper.md), the high-level scope in [`v1-plan.md`](./v1-plan.md), and the differential test substrate in [`test-plan.md`](./test-plan.md). Forward-looking research is in [`research.md`](./research.md).
