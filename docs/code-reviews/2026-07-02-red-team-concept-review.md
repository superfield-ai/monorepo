...
The authorized docs sweep landed on 2026-07-02 across README.md, prd.md,
architecture.md, milestone-1.md, eval-design.md, testing.md,
rust-reorg-decisions.md, runtime-agent-selection.md,
control-template-integration.md, adr-schema-boundary.md,
adr-embedding-model.md, and ux/studio-ux.md; the status column above records
which remediations it completed (done), which it completed on the
documentation side only (docs done; code planned), and which remain
...
- Roadmap: banner-and-glossary hygiene this week; budget, approval-economics,
  ...
  ICP, IT-admin-grade appliance; the prd.md §1-§3 rewrite it implies landed in
  the 2026-07-02 docs sweep (see Remediation log).
