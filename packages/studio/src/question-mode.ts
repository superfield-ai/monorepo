...
export const CONTEXT_TOPIC_MAP: Record<string, string[]> = {
  auth: ['packages/studio/src/auth.ts', 'packages/studio/apps/web/src/controllers/OAuthController.ts'],
  login: ['packages/studio/src/auth.ts', 'packages/studio/apps/web/src/controllers/OAuthController.ts'],
  oauth: ['packages/studio/src/auth.ts', 'packages/studio/apps/web/src/controllers/OAuthController.ts'],
  chat: ['packages/studio/apps/web/src/controllers/ChatController.ts', 'packages/studio/src/claude-session.ts'],
  message: ['packages/studio/apps/web/src/controllers/ChatController.ts', 'packages/studio/src/claude-session.ts'],
  conversation: ['packages/studio/apps/web/src/controllers/ChatController.ts', 'packages/studio/src/claude-session.ts'],
  cluster: [
    'packages/studio-core/cluster-manager.ts',
    'packages/studio/apps/web/src/controllers/ClusterStatusController.ts',
    'packages/studio/src/cluster-events.ts',
  ],
  deploy: ['packages/studio-core/cluster-manager.ts', 'packages/studio-core/image-builder.ts'],
  build: ['packages/studio-core/image-builder.ts', 'packages/studio-core/manifest-parser.ts'],
  commit: ['packages/studio/apps/web/src/controllers/CommitController.ts', 'packages/studio/src/git.ts'],
  rollback: ['packages/studio/src/git.ts'],
  config: ['packages/studio-core/studio-config.ts', 'packages/studio/src/config.ts'],
  settings: ['packages/studio-core/studio-config.ts', 'packages/studio/src/config.ts'],
  database: ['packages/db/index.ts'],
  db: ['packages/db/index.ts'],
  session: ['packages/studio-core/studio-session.ts', 'packages/studio/src/claude-session.ts'],
  permission: ['packages/studio/src/permissions.ts'],
  security: ['packages/studio/src/permissions.ts', 'packages/studio/src/auth.ts'],
  api: ['packages/studio/src/api.ts', 'packages/studio/src/router.ts'],
  route: ['packages/studio/src/router.ts'],
  ui: ['packages/studio/apps/web/src/components/index.ts'],
  interface: ['packages/studio/apps/web/src/components/index.ts'],
  hot: ['packages/studio/src/hot-swap.ts'],
  swap: ['packages/studio/src/hot-swap.ts'],
  reload: ['packages/studio/src/hot-swap.ts'],
  process: ['packages/studio/src/process-manager.ts'],
};
...
export function selectRelevantFiles(question: string): string[] {
  ...
  if (matched.size === 0) {
    return [
      ...
      'packages/studio-core/studio-config.ts',
    ];
  }
