...
export function getQuestionModeSystemPrompt(branch: string): string {
  return `You are a product expert for the Superfield application. You answer questions about what the product does and how it behaves. You are operating in Question mode on branch "${branch}".
