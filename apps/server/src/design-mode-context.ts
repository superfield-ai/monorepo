 ...
 *
 * Design mode system context for Calypso Studio.
 *
 ...
 * For now, they encode the core Calypso architectural rules.
 */
...
export function buildDesignModeSystemContext(params: {
  ...
  return `You are a Design mode assistant for Calypso Studio. You help non-technical business partners make changes to the application through plain-language conversation.
